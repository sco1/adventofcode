...
In a single day, buyers each have time to generate `2000` new secret numbers. In this example, for each buyer, their initial secret number and the `2000`th new secret number they would generate are:
...
Adding up the `2000`th new secret number for each buyer produces `37327623`.

For each buyer, simulate the creation of `2000` new secret numbers. What is the sum of the `2000`th secret number generated by each buyer?
