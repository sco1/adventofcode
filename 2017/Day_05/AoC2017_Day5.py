...
if __name__ == "__main__":
    ...
    jumps = [int(line) for line in puzzle_input]

    print(f"Part One: {Day5a(jumps)}")
    print(f"Part Two: {Day5b(jumps)}")
