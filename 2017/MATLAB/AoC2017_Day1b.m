...
% Assume an even number of digits
% 
% Consider the digit halfway around the circular list. That is, if your 
% list contains 10 items, only include a digit in your sum if the digit 
...
% Loop over all digits, checking ndigits/2 steps forward to see if the
% digit matches. If it matches, add it to the total
output = 0;
ndigits = length(m);
checkstep = ndigits/2;
for ii = 1:ndigits
